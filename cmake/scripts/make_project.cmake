...
if(NOT ("${BUILD_PROJECT_POSTFIX}" STREQUAL ""))
    set(BUILD_PROJECT_DIR "${BUILD_PROJECT_DIR}-${BUILD_PROJECT_POSTFIX}")
endif()
if(NOT "${BUILD_PROJECT_SUBDIR}" STREQUAL "")
    set(BUILD_PROJECT_DIR "${BUILD_PROJECT_DIR}/${BUILD_PROJECT_SUBDIR}")
endif()
